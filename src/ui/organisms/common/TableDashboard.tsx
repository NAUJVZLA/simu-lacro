...
import {
  Datum,
  Metadata,
} from "@/app/core/application/dto/common/projects-response.dto";
...
const TableDashboardClient: React.FC<TableDashboardClientProps> = ({
  initialData,
  initialMetadata,
}) => {
        ...
        <Dialog open={Boolean(editingRow)} onClose={() => setEditingRow(null)}>
          ...
          <DialogContent>
            ...
            <TextField
              ...
              onChange={(e) =>
                setEditingRow({ ...editingRow, startDate: e.target.value })
              }
            />
            <TextField
              fullWidth
              ...
              onChange={(e) =>
                setEditingRow({ ...editingRow, endDate: e.target.value })
              }
            />
          </DialogContent>
          <DialogActions>
            <Button onClick={() => setEditingRow(null)} color="success">
              Cancelar
            </Button>
