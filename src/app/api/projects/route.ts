...
export async function POST(request: Request) {
  const session = await getServerSession(authOptions); // Obtener sesión para verificar token
...
// Nuevo método PATCH para actualizar un proyecto
...
// Nuevo método DELETE para eliminar un proyecto
